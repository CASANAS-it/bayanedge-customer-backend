...
const customControllers = {
    init: router => {
        const baseUrl = `${Properties.api}/expense`
    ...
    get: async (req, res) => {
        try {
            ...
            expenseService.getAll(limit, offset,client_id).then(data => {
    ...
    getById: async (req, res) => {
        try {
            ...
            res.send(
                new CommonMessage({
                    data: await expenseService.getById(id)
                })
            )
        } catch (err) {
            const safeErr = ErrorManager.getSafeError(err)
    ...
    save: async (req, res) => {
        try {
            ...
            if (!req.body.id) {
                ...
                data = await expenseService.update(req.body)
            }
            res.send(
                new CommonMessage({
                    data: data
    ...
    delete: async (req, res) => {
        try {
            var data = await expenseService.delete(req.body)
